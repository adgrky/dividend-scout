...
echo "  何を更新しますか？"
echo ""
echo "    1) 株価・配当・スコア        約10分  ← ふだんはこれ"
echo "    2) ＋ 会社の基本情報          約20分  （月1回でよい）"
echo "    3) ぜんぶ（有価証券報告書も） 約80分  （年1回でよい）"
echo "    0) やめる"
echo ""
